...
class MinuteReturnVolumeChangeCorrelation(_BaseHighFreqFactor):
    factor_name = "MinuteReturnVolumeChangeCorrelation"
    factor_type = "price_volume_correlation"
    report_factor_code = "corr_prvr"
    calculation_logic = "分钟收益率与同期成交量变化率的相关系数。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            return returns.corr(volume_change)
