...
class VolumeWeightedReturnSkewness(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnSkewness"
    factor_type = "chip_distribution"
    report_factor_code = "doc_skew"
    calculation_logic = "按分钟收益率分组并以成交量为权重，计算收益率分布偏度。"
