...
class Top50ChipGroupVolumeShare(_BaseHighFreqFactor):
    factor_name = "Top50ChipGroupVolumeShare"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol50_ratio"
    calculation_logic = "按分钟收益率分组后成交量最大的50组占全天成交量比例。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            return grouped_volume.nlargest(50).sum() / grouped_volume.sum() if grouped_volume.sum() else float("nan")
