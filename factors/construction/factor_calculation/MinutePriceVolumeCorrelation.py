...
class MinutePriceVolumeCorrelation(_BaseHighFreqFactor):
    factor_name = "MinutePriceVolumeCorrelation"
    factor_type = "price_volume_correlation"
    report_factor_code = "corr_pv"
    calculation_logic = "分钟收盘价与同期成交量的相关系数。"
