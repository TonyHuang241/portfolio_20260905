...
class MinutePriceLeadingVolumeCorrelation(_BaseHighFreqFactor):
    factor_name = "MinutePriceLeadingVolumeCorrelation"
    factor_type = "price_volume_correlation"
    report_factor_code = "corr_pvl"
    calculation_logic = "分钟收盘价与领先一根的成交量相关系数。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            return close.corr(leading_volume)
