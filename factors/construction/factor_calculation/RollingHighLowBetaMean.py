...
class RollingHighLowBetaMean(_BaseHighFreqFactor):
    factor_name = "RollingHighLowBetaMean"
    factor_type = "momentum_reversal"
    report_factor_code = "mmt_ols_beta_mean"
    calculation_logic = "滚动50根分钟K线回归最高价对最低价所得beta的日内均值。"
    window = 50
