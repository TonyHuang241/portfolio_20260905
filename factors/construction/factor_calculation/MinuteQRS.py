...
class MinuteQRS(_BaseHighFreqFactor):
    factor_name = "MinuteQRS"
    factor_type = "momentum_reversal"
    report_factor_code = "mmt_ols_qrs"
    calculation_logic = "滚动50根分钟K线回归最高价对最低价，取beta乘R方后在日内求均值。"
    window = 50
