...
class VolumeWeightedReturnQuantile90(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnQuantile90"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol_pdf90"
    calculation_logic = "按成交量加权的分钟收益率分布90%分位。"

    @staticmethod
    def _weighted_quantile(group, quantile=0.9):
