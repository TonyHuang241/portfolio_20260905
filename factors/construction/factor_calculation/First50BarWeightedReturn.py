...
class First50BarWeightedReturn(_BaseHighFreqFactor):
    factor_name = "First50BarWeightedReturn"
    factor_type = "trade_activity"
    report_factor_code = "trade_top50retRatio"
    calculation_logic = "前50根分钟K线中收益率乘全天成交量占比后的均值。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            selected = group.iloc[:50] if "first" == "first" else group.iloc[-50:]
