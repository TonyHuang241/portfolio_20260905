...
class Bottom20VolumeBarReturn(_BaseHighFreqFactor):
    factor_name = "Bottom20VolumeBarReturn"
    factor_type = "momentum_reversal"
    report_factor_code = "mmt_bottom20VolumeRet"
    calculation_logic = "成交量最小的20根分钟K线收益率的复合值。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            selected = volume.nsmallest(20).index
