...
class OpeningVolumeRatio(_BaseHighFreqFactor):
    factor_name = "OpeningVolumeRatio"
    factor_type = "trade_activity"
    report_factor_code = "trade_headRatio"
    calculation_logic = "9:30至10:00成交量占全天成交量比例。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            mask = group["trade_time"].dt.time.between(pd.Timestamp("09:30").time(), pd.Timestamp("10:00").time())
