...
class Top5ChipGroupVolumeShare(_BaseHighFreqFactor):
    factor_name = "Top5ChipGroupVolumeShare"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol5_ratio"
    calculation_logic = "按分钟收益率分组后成交量最大的5组占全天成交量比例。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            return grouped_volume.nlargest(5).sum() / grouped_volume.sum() if grouped_volume.sum() else float("nan")
