...
class VolumeWeightedReturnQuantile95(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnQuantile95"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol_pdf95"
    calculation_logic = "按成交量加权的分钟收益率分布95%分位。"

    @staticmethod
    def _weighted_quantile(group, quantile=0.95):
