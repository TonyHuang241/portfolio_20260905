...
class First20BarWeightedReturn(_BaseHighFreqFactor):
    factor_name = "First20BarWeightedReturn"
    factor_type = "trade_activity"
    report_factor_code = "trade_top20retRatio"
    calculation_logic = "前20根分钟K线中收益率乘全天成交量占比后的均值。"
