...
class Last20BarWeightedReturn(_BaseHighFreqFactor):
    factor_name = "Last20BarWeightedReturn"
    factor_type = "trade_activity"
    report_factor_code = "trade_bottom20retRatio"
    calculation_logic = "最后20根分钟K线收益率按其全天成交量占比加权求和。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            selected = group.iloc[:20] if "last" == "first" else group.iloc[-20:]
