...
class VolumeWeightedReturnQuantile70(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnQuantile70"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol_pdf70"
    calculation_logic = "按成交量加权的分钟收益率分布70%分位。"

    @staticmethod
    def _weighted_quantile(group, quantile=0.7):
