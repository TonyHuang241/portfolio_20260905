...
class RollingHighLowCorrelationMean(_BaseHighFreqFactor):
    factor_name = "RollingHighLowCorrelationMean"
    factor_type = "momentum_reversal"
    report_factor_code = "mmt_ols_corr_mean"
    calculation_logic = "滚动50根分钟K线最高价与最低价相关系数的日内均值。"
    window = 50
