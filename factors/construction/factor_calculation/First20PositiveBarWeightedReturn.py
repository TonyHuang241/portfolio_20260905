...
class First20PositiveBarWeightedReturn(_BaseHighFreqFactor):
    factor_name = "First20PositiveBarWeightedReturn"
    factor_type = "trade_activity"
    report_factor_code = "trade_topPos20retRatio"
    calculation_logic = "前20根分钟K线中正收益率乘全天成交量占比后的均值。"
