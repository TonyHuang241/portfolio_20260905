...
class Top50VolumeBarReturn(_BaseHighFreqFactor):
    factor_name = "Top50VolumeBarReturn"
    factor_type = "momentum_reversal"
    report_factor_code = "mmt_top50VolumeRet"
    calculation_logic = "成交量最大的50根分钟K线收益率的复合值。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            selected = volume.nlargest(50).index
