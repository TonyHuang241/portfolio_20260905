...
class VolumeWeightedReturnStd(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnStd"
    factor_type = "chip_distribution"
    report_factor_code = "doc_std"
    calculation_logic = "按分钟收益率分组并以成交量为权重，计算收益率分布标准差。"
