...
class MinutePriceLaggingVolumeCorrelation(_BaseHighFreqFactor):
    factor_name = "MinutePriceLaggingVolumeCorrelation"
    factor_type = "price_volume_correlation"
    report_factor_code = "corr_pvd"
    calculation_logic = "分钟收盘价与滞后一根的成交量相关系数。"
    ...
    def calculate(self):
        ...
        def value(group):
            ...
            return close.corr(lagging_volume)
