...
class VolumeWeightedReturnQuantile80(_BaseHighFreqFactor):
    factor_name = "VolumeWeightedReturnQuantile80"
    factor_type = "chip_distribution"
    report_factor_code = "doc_vol_pdf80"
    calculation_logic = "按成交量加权的分钟收益率分布80%分位。"

    @staticmethod
    def _weighted_quantile(group, quantile=0.8):
